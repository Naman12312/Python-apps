...
if __name__ == "__main__":
    ...
    GAME_SPRITES['numbers'] = ( 
        pygame.image.load('o.png').convert_alpha(),
    ...
    GAME_SPRITES['message'] =pygame.image.load('bg.png').convert_alpha()
    ...
    # Game sounds
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('g.mp3')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('r.mp3')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('g1.mp3')
